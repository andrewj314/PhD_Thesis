...
mainly used for signal and background MC production. The predicted background yields in simulation were determined using cross sections with the strong coupling constant expanded to next-leading-order (NLO) or next-next-leading-order (NNLO), while the 
...
Table~\ref{tab:mc_samples} shows the entire list of MC samples used for this analysis. 
...
\begin{table}[htbp!]
  \caption{MC Samples used in 13 TeV analysis. The multiplicative terms take the cross section from leading order to NLO.} 
  \centering{
  \resizebox{\textwidth}{!}{
  \begin{tabular}{| l | c | c |} 
  \hline\hline 
...
\noindent to reweight MC events based on the number of interactions. 
