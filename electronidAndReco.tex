...
The electron selection requirements have two main components: electron  identification (eID) and electron isolation. 
...
\begin{table}[ht]
\begin{center}
 \caption{Electron ID selection criteria\label{eIDtable}}
 \begin{tabular}{| l | c | c | c |}
 \hline\hline
       Category                              & MVA$_{\textrm{min cut}}$ (80\% signal eff)	& MVA$_{\textrm{min cut}}$ (90\% signal eff)  \\[0.5ex] \hline
       Barrel ($\eta < 0.8$) $5 < p_{T} < 10$           	& 0.287435 & $-0.083313$             	\\
       Barrel ($\eta > 0.8$) $5 < p_{T} < 10$          	& 0.221846 & $-0.235222$             	\\
       Endcap $5 < p_{T} < 10$           			& $-0.303263$ & $-0.67099$             	\\
