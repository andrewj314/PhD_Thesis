...
Figure \ref{fig:8TeV_SR} and Figure \ref{fig:8TeV_BGRates} show the unblinded signal region and background rates after all backgrounds are estimated. Data agrees with SM expectation, so limits are set on the $Z^{\prime}_{SSM}$ visible mass.
...
Figure \ref{fig:8TeV_SignalRates} shows the predicted rates in the SR of several signal mass points considered in this analysis.
