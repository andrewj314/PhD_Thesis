...
\includegraphics[width=0.5\textwidth]{figures/Limit_noLifetime.pdf}
%\includegraphics[width=0.5\textwidth]{figures/Limit_Lifetime_gt_2_NoPZeta_123prong.pdf}
\includegraphics[width=0.5\textwidth]{figures/Limit_Lifetime_gt_3.pdf}
...
\begin{figure}[tbh!]
\centering
\includegraphics[width=0.5\textwidth]{figures/Limit_NoLifetime_NoPZeta_MET_gt_50.pdf}
\includegraphics[width=0.5\textwidth]{figures/Limit_Lifetime_gt_2_NoPZeta_123prong.pdf}
